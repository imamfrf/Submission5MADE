package com.imamfrf.dicoding.submission5made.provider
...
import com.imamfrf.dicoding.submission5made.favorite.FavoriteMovieFragment2
...
class MovieProvider : ContentProvider() {
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        context?.contentResolver?.notifyChange(DatabaseContract.MovieColumns().CONTENT_URI,
            FavoriteMovieFragment2.DataObserver(Handler(), context))
    ...
    private fun UriMatching(){
        // content://com.imamfrf.dicoding.submission5made/movie
        sUriMatcher.addURI(DatabaseContract().AUTHORITY, DatabaseContract().TABLE_MOVIE, MOVIE)
        // content://com.imamfrf.dicoding.submission5made/movie/id
