...
import com.imamfrf.dicoding.submission5made.db.DatabaseContract.TVShowColumns.Companion.BACKDROP
import com.imamfrf.dicoding.submission5made.db.DatabaseContract.TVShowColumns.Companion.DESCRIPTION
import com.imamfrf.dicoding.submission5made.db.DatabaseContract.TVShowColumns.Companion.FIRST_AIR_DATE
import com.imamfrf.dicoding.submission5made.db.DatabaseContract.TVShowColumns.Companion.ID
import com.imamfrf.dicoding.submission5made.db.DatabaseContract.TVShowColumns.Companion.POSTER
    ...
    companion object {
        ...
        fun getInstance(context: Context?): TVShowHelper =
            INSTANCE ?: synchronized(this) {
                INSTANCE ?: TVShowHelper(context as Context)
            }
