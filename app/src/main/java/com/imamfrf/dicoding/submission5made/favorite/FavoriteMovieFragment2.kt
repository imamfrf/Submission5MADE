...
import com.imamfrf.dicoding.submission5made.helper.MappingHelper

//USING CONTENT PROVIDER
class FavoriteMovieFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        context?.contentResolver?.registerContentObserver(DatabaseContract.MovieColumns().CONTENT_URI,
